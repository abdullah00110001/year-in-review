        ...
        <div className="mx-auto max-w-6xl relative">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {features.map((feature, index) => (
              <div key={feature.title} className="group relative" style={{ animationDelay: `${index * 100}ms` }}>
      ...
      <section className="py-24 px-4">
        <div className="mx-auto max-w-6xl">
          <div className="mb-16 text-center">
            ...
            <p className="text-lg text-muted-foreground">See what our users have to say about their transformation</p>
          </div>
          
          <div className="grid gap-6 md:grid-cols-3">
            {testimonials.map((testimonial, index) => (
              <div key={testimonial.author} className="group relative" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <div className="relative h-full rounded-3xl border border-border/50 bg-card/50 backdrop-blur-sm p-8 transition-all duration-300 hover:border-primary/30 hover:shadow-lg">
                  ...
                  <p className="text-sm text-foreground mb-6 italic">"{testimonial.quote}"</p>
                  <div className="flex items-center gap-3">
